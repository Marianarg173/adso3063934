...
<div class="bg-[#0006] p-10 rounded-xl shadow-xl max-w-3xl mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
        ...
        <ul class="space-y-3 text-white text-sm">
            ...
            <li><span class="text-[#fff9] font-bold">Document:</span> {{ $user->document }}</li>

            <li><span class="text-[#fff9] font-bold">Full Name:</span> {{ $user->fullname }}</li>
            ...
            <li><span class="text-[#fff9] font-bold">Updated at:</span> {{ $user->updated_at }}</li>
