...
<h1 class="text-4x1 text-black flex gap-2 items-center justify-center pb-4 border-b-2 border-neutral-50 mb-10">
...
<div class="flex flex-wrap gap-4 items-center justify-center">
    ...
    <div class="card text-black bg[#0006] w-96 shadow-sm">
        ...
        <div class="card-body">
            ...
            <ul class="list bg[#0003] backdrop-blur-sm rounded-box shadow-md">
